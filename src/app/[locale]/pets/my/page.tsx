...
export default function PetCollectionPage() {
  ...
  // 外部入口（今日幸运宠等）通过 URL 参数直达物种/稀有度（mine 固定 true）
  useEffect(() => {
        ...
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="rounded-full bg-violet-500 px-4 py-1.5 text-sm font-medium text-white shadow-sm transition hover:bg-violet-600 disabled:opacity-60"
            >
